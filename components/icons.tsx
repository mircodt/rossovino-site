...
export function WhatsappIcon({ className = "", ...rest }: IconProps) {
  // Logo WhatsApp ufficiale (Simple Icons) — cornetta centrata nel fumetto.
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} {...rest}>
      <path d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 2.1.55 4.15 1.6 5.96L2 22l4.25-1.65c1.75.95 3.71 1.45 5.79 1.45h.01c5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.9-7.01A9.82 9.82 0 0 0 12.04 2Zm0 1.67c2.2 0 4.27.86 5.82 2.42a8.19 8.19 0 0 1 2.41 5.82c0 4.54-3.7 8.23-8.24 8.23-1.85 0-3.66-.49-5.24-1.43l-.38-.22-2.52.98.99-2.46-.25-.39a8.18 8.18 0 0 1-1.25-4.36c0-4.54 3.7-8.23 8.24-8.23Zm-4.51 4.4c-.21 0-.55.08-.84.39-.29.31-1.11 1.08-1.11 2.64 0 1.56 1.14 3.06 1.3 3.27.16.21 2.23 3.4 5.4 4.77.75.32 1.34.51 1.8.66.76.24 1.45.21 1.99.13.61-.09 1.87-.76 2.13-1.5.26-.74.26-1.37.18-1.5-.08-.13-.29-.21-.61-.37-.32-.16-1.87-.92-2.16-1.03-.29-.11-.5-.16-.71.16-.21.31-.81 1.02-1 1.23-.18.21-.37.24-.68.08-.32-.16-1.34-.49-2.55-1.57-.94-.84-1.58-1.88-1.77-2.19-.18-.32-.02-.49.14-.64.14-.14.32-.37.47-.55.16-.18.21-.32.32-.53.11-.21.05-.4-.03-.56-.08-.16-.71-1.72-1-2.35-.26-.62-.52-.54-.71-.55-.18-.01-.4-.01-.61-.01Z" />
    </svg>
  );
}
