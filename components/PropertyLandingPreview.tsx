...
const CONTENT: Record<PropertySlug, LandingContent> = {
  ...
  "milano-boutique": {
    ...
    rooms: [
      { name: "Matrimoniale Superior", subtitle: "design e comfort", photo: "/images/boutique/rooms/matrimoniale-superior/01.jpg" },
      { name: "Tripla Superior", subtitle: "camera 309", photo: "/images/boutique/room-example/1.jpg" },
      { name: "Deluxe con Vasca", subtitle: "vasca freestanding", photo: "/images/boutique/rooms/suite-vasca/01.jpg" },
    ],
  ...
  milano: {
    ...
    rooms: [
      { name: "Matrimoniale Standard", subtitle: "comfort essenziale", photo: "/images/milano/rooms/matrimoniale-privato/01.jpg" },
      { name: "Doppia Letti Separati", subtitle: "matrimoniale + singolo", photo: "/images/milano/rooms/twin/01.jpeg" },
      { name: "Tripla Standard", subtitle: "due letti matrimoniali", photo: "/images/milano/rooms/tripla/01.jpeg" },
    ],
